 ...
 */
export function Tabs({ label, tabs, value, defaultValue, onChange, className = "" }: TabsProps) {
  const baseId = useId();
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`tap-target -mb-px whitespace-nowrap border-b-2 px-3 text-sm font-medium transition-[color,border-color] duration-fast ease-out-expo ${
                isSelected
