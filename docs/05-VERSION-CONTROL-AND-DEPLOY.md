...
Checked 2026-09-24 with `pnpm exec supabase migration list --linked`: rows 1–32 are applied to `vauokqoyvewtzubqajgh`, local and remote histories match (rows 4–21 were pushed on 2026-09-22 and 23, row 22 straight after #214 merged, row 23 straight after #220, row 24 straight after #222, row 25 straight after #224, row 26 straight after #226, row 27 straight after #228, row 28 straight after #230, row 29 straight after #245, row 30 after #247 and row 31 after #251 and row 32 after #254, all on 2026-09-24). Re-run that command before trusting this column; a new row is **not applied** until someone pushes it.
