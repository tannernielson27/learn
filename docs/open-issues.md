...
Last updated: 2026-09-23 (Sprint 9 under way: #204 merged in #214 and applied to hosted, which now has all 22 migrations; #206 merged in #216 (Resend; owner steps in docs/05 §7.7); #209 part 1 in #218. Sprint 8 is code complete, with the demo in `docs/sprints/S8-demo.md`).
